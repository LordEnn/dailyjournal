...
if (isset($_POST['simpan'])) {
    ...
    if ($simpan) {
        echo "<script>
            alert('Data diperbarui, Silahkan Log in ulang untuk memperbarui data');
            document.location=profile.php;
        </script>";
    } else {
        echo "<script>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="">
                        ...
                        <p style="font-weight: lighter;"><center><i>**Silahkan refresh untuk memperbarui data.**</center></i></p>
                    </form>
                </div>
            </div>
        </div>
