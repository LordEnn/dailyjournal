...
<head>
  ...
  <title>en's project</title>
  <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-cover bg-center h-screen" style="background-image: url('./img/cat.jpg');">
    <nav class=" p-4">
  ...
  <footer class="bg-gray-800 p-2  text-center text-white">
    <p>&copy;Copyright © 2024 rienshii. All Rights Reserved</p>
  </footer>
</body>
</html>
<?php
